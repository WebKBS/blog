...
지원 중단?에 대한 예측 이슈는 [`여기`](https://github.com/contentlayerdev/contentlayer/issues) <br />
...
공식홈페이지에서도 제공한다. 코드를 복사하면 된다. [`여기`](https://velite.js.org/guide/with-nextjs)
...
<BodyImage src="./issue.png" title="오류 경고" />
