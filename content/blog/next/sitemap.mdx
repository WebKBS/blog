...
자세한 내용은 <MDXLink title="Next.js 공식문서 - sitemap.ts" href="https://nextjs.org/docs/app/api-reference/file-conventions/metadata/sitemap" />를 참고하세요.
...
자세한 내용은 <MDXLink title="Next.js 공식문서 - robots.ts" href="https://nextjs.org/docs/app/api-reference/file-conventions/metadata/robots" />를 참고하세요.
