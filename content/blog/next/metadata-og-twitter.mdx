...
저는 개인적으로 이러한 방법을 사용하지 않습니다. - 다른 방법이 있기 때문입니다. 잠시 후 설명합니다. <MDXLink title="metadata설정으로 이미지생성" href="https://recodelog.com/blog/next/metadata-og-twitter#image-파일-생성이-아닌-metadata-설정으로-이미지-사용하기" />

만약 .alt.txt 파일을 생성하고 싶다면 다음과 같이 공식문서에서 참고할 수 있습니다. <MDXLink title="공식문서 - opengraph-image.alt.txt" href="https://nextjs.org/docs/app/api-reference/file-conventions/metadata/opengraph-image#opengraph-imagealttxt" />

<br />

next js전용 .js .ts .tsx 파일을 사용하여 이미지를 생성하고 싶다면 다음과 같이 공식문서를
참고하세요. <MDXLink title="공식문서 - 코드(.js, .ts, .tsx)를 사용하여 이미지 생성" href="https://nextjs.org/docs/app/api-reference/file-conventions/metadata/opengraph-image#generate-images-using-code-js-ts-tsx" />
...
자세한 내용은 공식문서 <MDXLink title="metadataBase" href="https://nextjs.org/docs/app/api-reference/functions/generate-metadata#metadatabase" />
...
<MDXLink
  ...
  href="https://recodelog.com/blog/seo/og-image"
/>

## 팁.

웹사이트 제작후 배포까지 끝났다면, <MDXLink title="https://www.opengraph.xyz/" href="https://www.opengraph.xyz/" /> 이 사이트에서 opengraph 이미지를 확인할 수 있습니다.
