...
tags:
  ...
  - blog
  - mdx
thumbnail: '../../../assets/logos/velite.svg'
---
...
<MDXLink title="contentlayer" href="https://contentlayer.dev" /> 라는 MDX 마크다운
파일을 손쉽게 만들수 있는 라이브러리도 있었으나, 해당 사이트에 들어가서 Documentation
페이지로 이동하면 404페이지가 뜨는 것을 확인할 수 있었다. 아마도 지원이 중단된 것
같다.

지원 중단?에 대한 예측 이슈는

<MDXLink
  title="Contentlayer이슈 보기"
  href="https://github.com/contentlayerdev/contentlayer/issues"
/>
<br />꽤 많은 사람들이 Documentation 페이지가 404페이지가 나타난다는 이슈사항을 올려놓았다.
기간만 봐도 꽤 오래된듯하다.

그래서 다른 방법을 찾아보다가

<MDXLink title="Velite.js" href="https://velite.js.org" />를 사용해서 블로그를
만들어보기로 했다.

<MDXLink title="Velite.js" href="https://velite.js.org" />는 Next.js와 MDX를
사용해서 블로그를 만들 수 있게 도와주는 라이브러리이다.
<br />
`Velite.js`는 `contentlayer`의 영감을 받아서 개발되었다고 한다. 출시된지 얼마
안되었으며, 공식홈페이지에서도 아직 안정화는 부족하다고 얘기한다. 추후 지속적인
개발을 통해 나아질것이라고 한다.
...
- 아래는 예시일 뿐이다. 자신의 프로젝트에 맞게 설정하면 된다.
  <MDXLink
    title="Velite.js 공식문서"
    href="https://velite.js.org/guide/quick-start"
  /> 참고
...
공식홈페이지에서도 제공한다. 코드를 복사하면 된다. <MDXLink title="velite.config 공식문서" href="https://velite.js.org/guide/with-nextjs" />
...
<MDXImage src="./images/issue.png" alt="오류 경고" />
