...
Chromatic을 사용하려면 Chromatic 계정이 필요합니다. [`Chromatic 홈페이지`](https://www.chromatic.com/)에 접속하여 계정을 만들어주세요.

회원가입후 로그인하면 다음과 같은 깃허브 저장소 연동 화면이 나타납니다.

<MDXImage
  src="./images/storybook-github.png"
  title="로그인후 깃허브 연동 화면"
/>
...
<MDXImage src="./images/token.png" title="토큰 화면" />
...
[`스토리북 배포`](https://storybook.js.org/tutorials/intro-to-storybook/react/ko/deploy/)
```
